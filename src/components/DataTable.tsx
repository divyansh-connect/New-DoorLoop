...
import { ChevronDown, ChevronUp, ChevronsUpDown, EyeOff, Loader2, Search, Download, X } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-9 pr-8 py-2 text-xs font-medium bg-card border border-border rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
          />
          {globalFilter && (
            <button
        ...
        <div className="flex items-center gap-2 justify-end relative">
          <Button
            ...
            className="text-xs font-semibold flex items-center gap-1.5 border-emerald-500/30 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/10"
